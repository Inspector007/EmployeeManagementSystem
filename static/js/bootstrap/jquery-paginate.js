(function($) {
  ...
  var Paginator = function() {
    return {
      ...
      _createNavigationButtons: function() {
        ...
        this.nav.append($('<div>', $.extend({'style':'display:inline-block;'}, { text: String("Showing Page 1 "+"of "+String(this._totalPages())) })));
      ...
      _appendNavigation: function() {
        ...
        $('.page-navigation a[data-first]')[0].innerHTML = '<i class="more-less glyphicon glyphicon-step-backward"></i>'
        $('.page-navigation a[data-previous]')[0].innerHTML = '<i class="more-less glyphicon glyphicon-triangle-left"></i>'
        $('.page-navigation a[data-next]')[0].innerHTML = '<i class="more-less glyphicon glyphicon-triangle-right"></i>'
        $('.page-navigation a[data-last]')[0].innerHTML = '<i class="more-less glyphicon glyphicon-step-forward"></i>'
      ...
      _addNavigationCallbacks: function() {
        ...
        paginator.nav.find('a').click(function(e) {
          ...
          // String($('.page-navigation a[data-selected]')[0].innerHTML)
          $('.page-navigation div')[0].innerHTML = String("Showing Page "+ String($('.page-navigation a[data-selected]')[0].innerHTML) +" "+"of "+String(paginator._totalPages()))
          // console.log($('.page-navigation a[data-selected]')[0].innerHTML+"--"+$('.page-navigation a[data-page]').length);
  ...
  $.fn.paginate.defaults = {
    ...
    lastText: '>>',
    optional: true,
    onCreate: function(jquery_table_object) {$('.page-navigation a[data-page]').hide()},
    onSelect: null,
